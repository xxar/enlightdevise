...
<div id="pageTarget" class="module">
    <div class="module_container">
        <div class="container_target wow">您的位置：
            ...
            <a ><?=$class_r[$ecms_gr[classid]][classname]?></a>
            <i class="fa fa-angle-right"></i>
            <a ><?=$ecms_gr[title]?></a></div>
        <div class="clear"></div>
    </div>
</div>
<div class="content">
...
<div id="postInfo">
    <div class="wrapper scrollFixed" data-sf-top="20">
        ...
        <p class="subtitle"><?=$ecms_gr[ftitle]?></p>
...
<div id="postContent">
    <div class="postbody">
        <div id="imageWrapper" data-slider-num="1" data-slider-speed="1">
        ...
        <div class="mlist project">
            <div class="content_wrapper">
                <div class="content_list movedx" data-movedx-mid="2" data-movedx-distance="15">
                    <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq('selfinfo',12,0,0,'isgood=1');
if($ecms_bq_sql){
while($bqr=$empire->fetch($ecms_bq_sql)){
$bqsr=sys_ReturnEcmsLoopStext($bqr);
$bqno++;
