...
</table></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>职位类别</td><td bgcolor='ffffff'><input name="ftitle" type="text" size=60 id="ftitle" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[ftitle]))?>">
...
</table></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>更新时间</td><td bgcolor='ffffff'><input name="newstime" type="text" value="<?=$r[newstime]?>"><input type=button name=button value="设为当前时间" onclick="document.add.newstime.value='<?=$todaytime?>'"></td></tr></table>